    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/tcarvi-engenheiro-eduardo-leal/pesquisa-sobre-calculo/tree/main/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/tcarvi-engenheiro-eduardo-leal/pesquisa-sobre-calculo',
          label: 'GitHub',
          position: 'right',
        },
      ],
      ...
      links: [
        {
          ...
          items: [
            {
              label: 'Tutorial',
              to: '/docs/limites-derivadas-e-tecnicas-de-derivacao/limites-e-continuidade',
            },
          ],
        },
        {
